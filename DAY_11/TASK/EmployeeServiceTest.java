...
public class EmployeeServiceTest {
    ...
    void testGetById(){
        ...
        assertEquals("nithya", result.getName());
    ...
    void testAddEmployee() {
        ...
        dto.setEmpId(1);
        dto.setName("nithya");
        dto.setEmail("nithya@example.com");
        dto.setUserName("nithya123");
        ...
        when(passwordEncoder.encode("nithya")).thenReturn("nithya-encoded");
